...
Интерактивный прототип раздела «Лента» для Яндекс Мед — профессиональной ленты для врачей, встроенной в существующий продукт. Две адаптации из одной модели данных: **Desktop web** и **iPhone 15 Pro Max**.
